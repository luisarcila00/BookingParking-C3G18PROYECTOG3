            ...
            <v-row align="center" justify="center">
              <v-col cols="10">
                ...
                <v-text-field
                  ...
                  type="number"
                  min="0"
                  v-on:keyup.enter="confirmarMostrar()"
                >
                ...
                <v-text-field
                  ...
                  :rules="totalRules"
                  v-model="reservadosCup"
                  type="number"
                  min="0"
                  v-bind:max="maximum"
                  v-on:keyup.enter="confirmarMostrarReservas()"
                >
                ...
                <div class="botones" v-if="isHidden">
                  ...
                  <v-btn
                    ...
                    color="secondary"
                    dark
                    v-on:click="confirmarMostrarReservas()"
                  >
                    <v-icon left> mdi-check-bold</v-icon>
                    Confirmar
                  </v-btn>
                ...
                <v-text-field
                  ...
                  type="number"
                  min="0"
                  v-bind:max="maximumCars"
                  v-on:keyup.enter="confirmarMostrarCar()"
                >
                ...
                <div class="botones" v-if="isHiddenCars">
                  ...
                  <v-btn
                    ...
                    color="secondary"
                    dark
                    v-on:click="confirmarMostrarCar()"
                  >
                    <v-icon left> mdi-check-bold</v-icon>
                    Confirmar
                  </v-btn>
                ...
                <v-text-field
                  ...
                  type="number"
                  min="0"
                  v-bind:max="maximumMot"
                  v-on:keyup.enter="confirmarMostrarMot()"
                >
...
export default {
  data: () => ({
    ...
    maximumCars: "",
    maximumMot: "",
    totalRules: [(value) => !!value || "Required."],
    snackbar: false,
    snackbarText: "",
  }),
